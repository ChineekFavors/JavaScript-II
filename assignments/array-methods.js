...
// Problem 1
//function find runner with the first name falito
let findFalito = runners.filter(function(element){
	return element['first_name'] === 'Falito';
})
//console.log(findFalito);

// Problem 2
// function add 10 more dollars to runners donation
let addTen = runners.map(function(a){
	return a['donation'] + 10;
})
//console.log(addTen);
